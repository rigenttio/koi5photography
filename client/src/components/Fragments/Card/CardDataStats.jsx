...
const CardDataStats = ({ title, total, rate, levelUp, levelDown, children }) => {
  return (
    <div className="rounded-sm border border-slate-200 bg-white py-6 px-7 shadow-xl">
      <div className="flex h-11 w-11 items-center justify-center rounded-full bg-slate-100">{children}</div>
